...
function Footer() {
    return (
        <div style={{ width: '100%', height: '300px', background:'black',color:'white'}} className='d-flex flex-column justify-content-center align-items-center'>
            <div className="footer-div d-flex justify-content-evenly w-100 flex-wrap">
                <div className="website" style={{ width: '400px' }}>
                    <h5><i className="fa-solid fa-truck-fast"></i>
                        E Cart</h5>
                    ...
                    <h6>Code licensed krishnaveni, docs CC BY 3.0.</h6>
